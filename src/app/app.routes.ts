...
export const routes: Routes = [
    ...
    { path: 'favorites', loadComponent: () => import('./features/favorites/components/favorite-list/favorite-list.component').then(m => m.FavoriteListComponent),canActivate: [AuthGuard] },
